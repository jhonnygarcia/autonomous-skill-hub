...
const ES: Record<string, string> = {
  ...
  "decisions.allAnswered": "decisiones respondidas · aquí se cambia una respuesta",
  ...
  "decisions.reopen": "Cambiar respuesta",
  ...
  "status.pendingDecisions": "{list} deja {n} sin responder: contéstalas antes de seguir",
...
const EN: Record<string, string> = {
  ...
  "decisions.allAnswered": "decisions answered · change an answer here",
  ...
  "decisions.reopen": "Change answer",
  ...
  "status.pendingDecisions": "{list} left {n} unanswered: answer them before moving on",
